...
import (
	...
	"github.com/bfenetworks/bfe-access-pb/bfe-pblog-tool/bfe_reader"
	"github.com/bfenetworks/bfe-access-pb/bfe-pblog-tool/cmd/common"
...
func (t *tailCmd) Action(ctx *cli.Context) error {
	...
	opts := bfe_reader.TailOptions{N: n, Follow: follow}
	...
	return bfe_reader.PblogTail(fp, opts, func(line string) error {
		if canceled {
			return bfe_reader.ErrTailStop
		}
		fmt.Println(line)
		return nil
	})
