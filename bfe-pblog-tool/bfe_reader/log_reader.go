...
// log_reader.go - Read access log record from log file
//
// Modification history:
//   - 2014/11/5, by Zhang Miao, create
//   - 2016/3/14, by Zhang Miao, copy from pb_log_reader.go
//   - 2016/4/15, by Zhang Miao, copy from pb_log_reader2.go
//   - 2016/4/15, by Dai Ming, copy from pb_log_reader3.go
//   - 2022/03/31, by tianpengwei, modify
...
func (lr *LogFileReader) logFileOpen() error {
	...
	if !lr.initDone {
		_, err = fd.Seek(0, 2)
		log.Logger.Debug("Open the pb log first time, seek to the end now")
		if err != nil {
